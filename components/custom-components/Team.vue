                ...
                <v-col cols="12" sm="8">
                    <div class="text-center">
                        <div class="d-flex align-center mb-5 justify-center" data-aos="fade-right" data-aos-delay="200"
                            ...
                            <h6 class="text-subtitle-1 text-dark font-weight-bold">Equipe</h6>
                        </div>
                        <h2 class="text-h2 text-dark mb-3" data-aos="fade-left" data-aos-delay="200"
                            data-aos-duration="1000">Notre équipe</h2>
                            <p class="text-muted mb-4">Nous vous présentons un aperçu des membres de notre équipe.</p>
                    </div>
                </v-col>
            </v-row>
            <v-row class="justify-center">
