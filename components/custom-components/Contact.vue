            ...
            <v-row justify="center">
                ...
                <v-col cols="12" md="4">
                    <div class="bg-primary pa-sm-10 pa-5 rounded-md">
                        ...
                        <p class="mt-7 op-8 mb-0 text-white">+1 234 456 789</p>
                        <p class="op-8 mb-8 text-white">info@dsconsulting.com</p>
                        <p class="mt-7 op-8 mb-0 text-white">601 Rue 7896.</p>
                        <p class="op-8 mb-0 text-white">San B, CA 92404</p>
                    </div>
                </v-col>
            </v-row>
            <!-- -----------------------------------------------
