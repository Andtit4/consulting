    ...
    <v-navigation-drawer color="white" class="drawer px-3" v-model="drawer" temporary >
      <perfect-scrollbar class="scrollnavbar">
        ...
        <v-list class="menu text-capitalizew-100">
                ...
                <v-btn color="primary" class="mt-3" block size="large" target="_blank" href="https://adminmart.com/product/landingpro-nuxt-website-template/" variant="flat">Login</v-btn>
            </v-list>
      </perfect-scrollbar>
    </v-navigation-drawer>
      ...
      <v-container class="py-0">
        <v-toolbar class=" h-auto d-flex  bg-surface">
          ...
          <div class="d-md-flex d-none">
            <v-btn color="primary" class="ms-3 sticky-border d-md-flex d-none" target="_blank" href="https://adminmart.com/product/landingpro-nuxt-website-template/" size="large" variant="flat">Login</v-btn>
          </div>
